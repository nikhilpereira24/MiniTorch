    ...
    class Backend:
        ...
        class Sigmoid(Function):
            ...
            def backward(ctx, grad_output):
                ...
                # Getting a from forwards
                sigma = ctx.saved_values
                # Returning derivative * grad_output
        ...
        class LT(Function):
            ...
            def backward(ctx, grad_output):
                ...
                # return (
                #     mul_zip(tensor([0.00]), grad_output),
                #     mul_zip(tensor([0.00]), grad_output),
                # )
        ...
        class Permute(Function):
            ...
            def forward(ctx, a, order):
                ...
                # return Tensor.make(
                #     a._tensor.permute(*order)._storage,
                #     a._tensor.permute(*order).shape,
                #     backend=a.backend,
                # )
            ...
            def backward(ctx, grad_output):
                ...
                # reversed = list(range(len(originalOrder)))
                # for i, val in enumerate(originalOrder):
                #     reversed[val] = i
                # return Tensor(
                #     grad_output._tensor.permute(*reversed), backend=grad_output.backend
                # )
